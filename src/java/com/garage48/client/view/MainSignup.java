...
import com.garage48.client.http.RequestBundle;
 ...
 */
public class MainSignup extends Composite implements MainSignupView {
    ...
    public MainSignup() {
        ...
        signupPanel.add(new HTML("<h2 class='title'>Login to MyCash</h2>"));
        ...
        signupPanel.add(new HTML("<a href='" + rb.getGoogleOpenIdURL() + "'>" + img + "</a></div>"));
